...
const ProductWishList = ({ product, showRemove, showEye }) => {
    ...
    return (
        <div className='group relative z-30'>
            ...
            {product.discountPercentage && <div className='bg-buttoncolor px-1 rounded-md absolute left-2 top-2 text-xl text-white '>{product.discountPercentage < 1 ? Math.max(product.discountPercentage).toFixed(2) : Math.max(product.discountPercentage).toFixed(0)}%</div>}

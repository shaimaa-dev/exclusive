...
const WishListProducts = () => {
    ...
    const moveAllProductsToCart = () => {
        dispatch({type:"MOVE_WISHLIST_TO_CART", payload:wishListProducts})
    }
  return (
    <div className='w-[85%] mx-auto my-20'>
            <div className='flex justify-between '>
                <h3 className='text-2xl'>Wishlist</h3>
                <button onClick={moveAllProductsToCart} className='capitalize py-2 px-6 border-[1px] border-black rounded-sm'>move all to bag</button>
            </div>
